...
/**
 * A tool for comparing the blocks which are accepted/rejected by pacd/pacj
 * It is designed to run as a testnet-in-a-box network between a single pacd node and pacj
...
public class BitcoindComparisonTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("USAGE: pacjBlockStoreLocation runExpensiveTests(1/0) [port=18444]");
